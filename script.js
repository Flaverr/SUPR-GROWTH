...
#player-name { font-size: 2em; color: #000; } /* Default black */
...
#supercollateral-progress.active::after, #burn-debt-progress.active::after {
    transform: scaleX(0);
}
...
/* Leaderboard */
#leaderboard { background: rgba(255, 255, 255, 0.2); padding: 10px; border-radius: 5px; color: #000; text-align: center; width: 100%; }
...
#rankings-container { display: flex; justify-content: space-between; width: 100%; }
#daily-rankings, #all-time-rankings { width: 48%; }
#leaderboard ul { list-style: none; padding: 0; margin: 5px 0; font-size: 0.9em; }
#leaderboard h3 { font-size: 1.2em; margin: 10px 0 5px; }

/* Popups */
#game-over, #mystery-popup { position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0, 0, 0, 0.7); display: none; }
#game-over.active, #mystery-popup.active { display: flex; justify-content: center; align-items: center; }
#game-over-content, #mystery-content { background: #222; padding: 20px; border-radius: 10px; text-align: center; color: #fff; width: 400px; max-width: 90%; border: 2px solid #91D3D1; box-shadow: 0 0 10px rgba(145, 211, 209, 0.5); }
...
.mystery-option button { width: 100%; padding: 12px; background: #FFD700; border: none; border-radius: 5px; font-size: 1.2em; font-weight: 900; cursor: pointer; transition: background 0.2s ease; display: flex; align-items: center; justify-content: center; gap: 10px; }
...
.progress-bar { width: 100%; height: 5px; background: #555; margin-top: 5px; border-radius: 3px; overflow: hidden; }
.progress-bar::after { content: ''; display: block; width: 100%; height: 100%; background: #91D3D1; transform: scaleX(1); transform-origin: left; transition: transform 30s linear; }
.progress-bar.active::after { transform: scaleX(0); }
...
/* Buttons */
#sound-toggle, #theme-toggle, #pause-button { position: fixed; bottom: 20px; right: 20px; padding: 10px; font-size: 1.5em; background: #212121; color: #fff; border: none; border-radius: 50%; cursor: pointer; }
